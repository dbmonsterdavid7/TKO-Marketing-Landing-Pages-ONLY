...
export default function WebsiteCalendarThankYou() {
  useEffect(() => {
    ...
    <div className="grow-page-root min-h-screen">
      ...
      <header className="header-minimal">
        ...
        <Link to="/website" className="back-home-link">
          <ArrowLeft size={16} /> Back to Website Showcase
        </Link>
      </header>
      ...
      <section className="thank-you-section">
        <div className="container-narrow">
          ...
          <div className="success-icon-wrap">
            <div className="success-icon" style={{ borderColor: 'var(--green)', color: 'var(--green)' }}>
          ...
          <p className="sub-heading">
            Awesome! Your live website walkthrough and strategy session is officially secured. We are excited to present your brand new custom layout draft!
          </p>
          ...
          <div className="steps-container">
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>
                  <Calendar size={18} />
                  Check Your Email & Text Invitations
                </h3>
                <p>
                  We have sent a calendar invitation and confirmation receipt directly to your registered phone number and inbox. Please <strong>be sure to accept the invitation</strong> to save it directly to Google Calendar, Apple Calendar, or Outlook.
                </p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>
                  <Smartphone size={18} />
                  Get Ready to Launch Instantly
                </h3>
                <p>
                  If you love the layout during our call, we can connect it to your domain, set up the companion Mobile App, and have it completely live delivering leads within 24 hours.
                </p>
              </div>
            </div>
          ...
          <Link to="/website" className="btn-accent btn-pulse text-center inline-block">
